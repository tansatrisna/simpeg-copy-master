    ...
    <div class="row">
    	<div class="col-md-6">
    		<div class="panel panel-inverse">
                <div class="panel-heading">
                    <div class="panel-heading-btn">
                        <?=aksiDetail('statistik/detail','publikasi','Lihat Statistik Lengkap')?>
                    </div>
                      ...
                      <tbody>
                           ...
                           $tpr=0;
                            foreach ($record as $row) {
                              $no++;
                              $lk=jlhJkPub('L',$row['jenis'],$jenis,$unit);
                              $pr=jlhJkPub('P',$row['jenis'],$jenis,$unit);
                              echo '<tr>
                                    <td>'.$no.'</td>
                              ...
                              array_push($jk, ["label"=>viewKodeApp('MEDIAPUB',$row['jenis']), "jlh"=>$row['jlh']]);
                              $tlk=$tlk+$lk;
                              $tpr=$tpr+$pr;
                              $total=$total+$row['jlh'];
                            }
