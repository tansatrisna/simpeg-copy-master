  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody class="text-center">
          ...
          foreach ($record as $row) {
            $no++;
            $dl=jlhJkStatus($row['kderef'],'DOSEN','L',$unit);
            $dp=jlhJkStatus($row['kderef'],'DOSEN','P',$unit);
            $pl=jlhJkStatus($row['kderef'],'PEGAWAI','L',$unit);
            $pp=jlhJkStatus($row['kderef'],'PEGAWAI','P',$unit);
            $tl=$dl+$pl;
            $tp=$dp+$pp;
            $ts=$tl+$tp;
            echo '<tr >
