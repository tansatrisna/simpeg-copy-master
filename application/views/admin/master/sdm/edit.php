      ...
      <!-- begin page-header -->
      <h1 class="page-header"><?=$header?> <small>Form Edit <?=$title?></small></h1>
      <!-- end page-header -->
<?php
...
?>
          ...
          <!-- begin row -->
<form class="form-horizontal"  action="<?=base_url()?>master/sdmedit" enctype="multipart/form-data" method="POST">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-inverse">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="idsdm" class="form-control" value="<?=$rows['idsdm']?>" placeholder="Nama Unit" readonly>
                  </div>
              </div><!-- row -->
               <!-- /.form-group row -->
