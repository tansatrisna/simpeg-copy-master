      ...
      <!-- begin page-header -->
      <h1 class="page-header"><?=$header?> <small>Form Tambah <?=$title?></small></h1>
      <!-- end page-header -->

      
          <!-- begin row -->
<form class="form-horizontal"  action="<?=base_url()?>master/sdmtambah" enctype="multipart/form-data" method="POST">
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-inverse">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="idsdm" class="form-control" value="<?=idSdm('SDM')?>" placeholder="Nama Unit" readonly>
                  </div>
              </div><!-- row -->
               <!-- /.form-group row -->
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nip" class="form-control" value="" placeholder="NIP/ Kode Pegawai" >
                  </div>
              </div><!-- row -->
              ...
              <div class="form-group row" id="nidn">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nidn" class="form-control" value="" placeholder="NIDN Dosen" >
                  </div>
              </div><!-- row -->
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="gelar_depan" class="form-control" value="" placeholder="Gelar Depan">
                  ...
                  <div class="col-sm-3">
                    <input type="text" name="gelar_belakang" class="form-control" value="" placeholder="Gelar Belakang" required>
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="tempat_lahir" class="form-control" value="" placeholder="Tempat Lahir" >
                  </div>
              </div><!-- row -->
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="nik" class="form-control" value="" placeholder="NIK/ Nomor KTP" >
                  </div>
              </div><!-- row -->
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="hp" class="form-control" value="" placeholder="Nomor HP" >
                  </div>
              </div><!-- row -->
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="kodepos" class="form-control" value="" placeholder="Kode Pos" >
                  </div>
              </div><!-- row -->
          ...
          <div class="col-md-6">
            ...
            <div class="panel panel-inverse">
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-10">
                    <input type="email" name="email_institusi" class="form-control" value="" placeholder="Email Institusi">
                  </div>
              </div><!-- row -->
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="npwp" class="form-control" value="" placeholder="NPWP">
                  </div>
              </div><!-- row -->
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="norek" class="form-control" value="" placeholder="Nomor Rekening">
                  </div>
              </div><!-- row -->
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="no_sk" class="form-control" value="" placeholder="Nomor SK" required>
                  </div>
              </div><!-- row -->
              ...
              <div class="form-group row" >
                  ...
                  <div class="col-sm-10">
                    <input type="date" name="mulai_masuk" class="form-control" value="" placeholder="Mulai Masuk Kerja" required="">
                  </div>
              </div><!-- row -->
