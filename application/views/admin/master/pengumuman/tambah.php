      ...
      <!-- end page-header -->
          ...
          <!-- begin row -->
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse">
                            ...
                            <form class="form-horizontal"  action="<?=base_url()?>master/pengumumantambah" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                   <select name="target" id="target" class="form-control" required>
                     ...
                     <?=opEnum('simpeg_pengumuman_sdm','target')?>
                   </select>
                  </div>
                </div><!-- row -->
              ...
              <div id="sdm" class="form-group row">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                   <textarea name="isi" class="mytextarea" required></textarea>
                  </div>
              </div><!-- row -->
