                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse">
                            ...
                            <form class="form-horizontal"  action="<?=base_url()?>master/pejabattambah" enctype="multipart/form-data" method="POST">
              ...
              <div class="form-group row">
               ...
               <!-- /.form-group row -->
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                   <input type="number" name="urutan" class="form-control" value="" placeholder="">
                  </div>
                </div><!-- row -->
