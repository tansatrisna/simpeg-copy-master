      ...
      <!-- end page-header -->
          ...
          <!-- begin row -->
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-inverse">
                            ...
                            <form class="form-horizontal"  action="<?=base_url()?>kuisioner/kuantitatiftambah" enctype="multipart/form-data" method="POST">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <textarea name="soal" class="mytextarea"></textarea>
                  </div>
              </div>
               <!-- /.form-group row -->
