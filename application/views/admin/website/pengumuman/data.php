          ...
          <!-- begin row -->
                <div class="row">
                        ...
                        <div class="panel panel-inverse">
                            <div class="panel-heading">
                                <div class="panel-heading-btn">
                                    ...
                                    {
                                       echo aksiTambah('website/pengumumantambah');
                                    }
                                    ?>
                                </div>
                    ...
                    echo '<tr><td>'.$no.'</td>
                              ...
                              {
                                echo aksiEdit('website/pengumumanedit',enkrip($row['id']));
                              }
                              echo'&nbsp;';
                              if(bisaHapus($link,$id_level)==1)
                              {
                               echo aksiHapus('website/pengumumanhapus',enkrip($row['id']));
                              }
                              echo'</center></td>
                          </tr>';
                      $no++;
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#modalLihat').on('show.bs.modal', function (e) {
            ...
            $.ajax({
                type : 'POST',
                url : '<?=base_url('website/pengumumanlihat')?>',
                data :  'rowid='+ rowid,
