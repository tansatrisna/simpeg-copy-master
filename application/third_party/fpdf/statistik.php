...
function Header()
	{
		...
		if($seo=='jk')
		{
			$judul = 'REKAP SDM BERDASARKAN JENIS KELAMIN';
			$kolom = 'Unit';
		}
		else if($seo=='golongan') {
			$judul = 'REKAP SDM BERDASARKAN GOLONGAN';
			$kolom = 'Golongan';
		}
		else if($seo=='pendidikan') {
			$judul = 'REKAP SDM BERDASARKAN PENDIDIKAN';
			$kolom = 'Pendidikan';
		}
		else if($seo=='agama') {
			$judul = 'REKAP SDM BERDASARKAN AGAMA';
			$kolom = 'Agama';
		}
		else if($seo=='usia') {
			$judul = 'REKAP SDM BERDASARKAN RENTANG USIA';
			$kolom = 'Rentang Usia';
		}
		else if($seo=='status') {
			$judul = 'REKAP SDM BERDASARKAN STATUS';
			$kolom = 'Status SDM';
		}
		...
		$this->Cell(185, 5, $judul, '', 0,'C');	
		if($unit!='')
		{
		$this->Ln();
		$this->Cell(185, 5, viewUnit($unit), '', 0,'C');	
		$this->Ln(7);
		}
		else
		{
		...
		$this->Cell(10, 12, 'No', 'LTBR', 0,'C');
		$this->Cell(60, 12, $kolom, 'TBR', 0,'C');	
		$this->Cell(30, 7, 'Dosen', 'TR', 0,'C');
		$this->Cell(30, 7, 'Pegawai', 'TR', 0,'C');
		$this->Cell(50, 7, 'Jumlah', 'TR', 0,'C');
		
		
		$this->Ln(6);
		$this->Cell(70, 0, '', '', 0,'C');	
		$this->Cell(15, 6, 'L', 'TBR', 0,'C');
		$this->Cell(15, 6, 'P', 'TBR', 0,'C');
		$this->Cell(15, 6, 'L', 'TBR', 0,'C');
		$this->Cell(15, 6, 'P', 'TBR', 0,'C');
		$this->Cell(15, 6, 'L', 'TBR', 0,'C');
		$this->Cell(15, 6, 'P', 'TBR', 0,'C');
		$this->Cell(20, 6, 'L+P', 'TBR', 0,'C');
