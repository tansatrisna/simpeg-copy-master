...
function Header()
	{
		...
		if($jenis!='')
		{
		$this->Cell(270, 5, 'DAFTAR PENGABDIAN KEPADA MASYARAKAT '.$jenis, '', 0,'C');
		}	
		else
		{
			$this->Cell(270, 5, 'DAFTAR PENGABDIAN KEPADA MASYARAKAT SDM', '', 0,'C');
		}
		...
		$this->Cell(120, 6, 'Judul Pengabdian', 'TR', 0,'C');
