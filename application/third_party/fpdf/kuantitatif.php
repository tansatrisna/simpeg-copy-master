...
function Header()
	{
		...
		$ci = & get_instance();
		$kuisioner=dekrip($ci->uri->segment('3'));
		...
		$this->Cell(185, 5, 'HASIL KUANTITATIF KUISIONER', '', 0,'C');	
		$this->Ln();
		$this->Cell(185, 5, viewKuisioner($kuisioner), '', 0,'C');	
		$this->Ln(7);
		$this->Cell(20, 5, 'Target', '', 0,'L');
		$this->Cell(5, 5, ':', '', 0,'C');
		$this->Cell(20, 5, $jenis, '', 0,'L');
		$this->Ln();
		if($unit!='')
		{
		$this->Cell(20, 5, 'Unit', '', 0,'L');
		$this->Cell(5, 5, ':', '', 0,'C');
		$this->Cell(20, 5, viewUnit($unit), '', 0,'L');
		$this->Ln();
		}
		else
		{
		$this->Cell(20, 5, 'Unit', '', 0,'L');
		$this->Cell(5, 5, ':', '', 0,'C');
		$this->Cell(20, 5, 'Semua Unit', '', 0,'L');
		$this->Ln();	
		}
		$this->SetFont("Arial", "B", 10);
		$this->Cell(10, 12, 'No', 'LTBR', 0,'C');
		$this->Cell(65, 12, 'Pertanyaan', 'TBR', 0,'C');
		$this->Cell(15, 12, 'Resp.', 'TBR', 0,'C');	
		$this->Cell(75, 7, 'Skor', 'TR', 0,'C');
		$this->Cell(15, 12, 'Rata2', 'TBR', 0,'C');
		
		$this->Ln(6);
		$this->Cell(90, 0, '', '', 0,'C');	
		$this->Cell(15, 6, '1', 'TBR', 0,'C');
		$this->Cell(15, 6, '2', 'TBR', 0,'C');
		$this->Cell(15, 6, '3', 'TBR', 0,'C');
		$this->Cell(15, 6, '4', 'TBR', 0,'C');
		$this->Cell(15, 6, '5', 'TBR', 0,'C');
		$this->Cell(15, 0, '', '', 0,'C');
		$this->Ln(6);
	}
